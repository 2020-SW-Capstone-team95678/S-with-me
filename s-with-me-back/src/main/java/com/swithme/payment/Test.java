package com.swithme.payment;

import com.swithme.payment.request.Cancel;
...
public class Test {
    ...
    public static void goVerfity() {
        try {
            HttpResponse res = api.verify("5ee205098f0751003a7f8f97");
    ...
    public static void goCancel() {
        ...
        cancel.receipt_id = "5ee205098f0751003a7f8f97";
        cancel.name = "관리자 홍길동";
